...
adminRouter.route("/coupons").get(authenticate, adminContoller.couponsGet);
...
adminRouter.route("/offers").get(authenticate, adminContoller.offerGet);

adminRouter
  .route("/api/offers/type")
