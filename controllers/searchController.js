...
export async function searchGet(req, res){
    ...
    try {
      ...
      res.status(500).json({status: 'failed', message: 'An error occurred during the search.'});
    };
...
export async function searchApi(req, res){
    ...
    try {
        ...
        console.error(error.message);
        return res.status(500).json({status: 'failed', message: 'An error occurred during the search.'});
      };
